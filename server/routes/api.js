...
router.get('/allCountries', dataController.getAllCountries)
router.post('/addNewClient', dataController.addNewClient)
router.put('/updateClient', dataController.updateClient)
